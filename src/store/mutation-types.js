...
export const USER_PRICE = 'USER_PRICE'
export const USER_ADDRESSID = 'USER_ADDRESSID'
export const BOON_PRICE = 'BOON_PRICE'
export const MANJIAN_FEESPRICE = 'MANJIAN_FEESPRICE'
export const MENU_REMIND = 'MENU_REMIND'
